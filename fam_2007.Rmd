...
dt_07[, "0_work":=  ifelse(dt_07$"0_work" %in% c(2,6), 7,dt_07$"0_work" ) ]
dt_07[, "0_work":=  ifelse(dt_07$"0_work" == 4, 5, dt_07$"0_work" ) ]
dt_07[, "0_work":=  ifelse(dt_07$"0_work" %in% c(3,5), 4,dt_07$"0_work" ) ]
dt_07[, "0_marstat":= 1]
dt_07[, "0_livstat":= 0]
dt_07[, "0_livwhere":= 0]
dt_07[, "0_meet":= 0]
