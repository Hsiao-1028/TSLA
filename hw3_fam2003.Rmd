...
cols<- c(unlist( lapply(paste0("^", 1:25,"_"), function(x){grep(x, names(dt_03y), value = T)})))
class(cols)
...
cols<- c(unlist( lapply(paste0("^", 1:25,"_"), function(x){grep(x, names(dt_03o), value = T)})))
class(cols)
...
cols<- unlist(lapply(1:25, function(x){paste0(x,liv)}))
cols<- append(c("ser_no", "survey_year", "qtype","adl_who_help"), cols)
tt<- dt_03y[, .SD, .SDcols=cols ] 

x<- list( c(paste0(1:25, "_relation")), c(paste0(1:25, "_gender")), c(paste0(1:25, "_age")), c(paste0(1:25,"_edu")), c(paste0(1:25, "_work")), c(paste0(1:25, "_marstat")), c(paste0(1:25, "_livstat")), c(paste0(1:25, "_livwhere")), c(paste0(1:25, "_meet")), c(paste0(1:25, "_tele")))
...
dt_03o_reshape <- as.data.table(dt_03y_reshape)
